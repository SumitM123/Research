...
export const FilesProvider = ({ children }) => {
  ...
  return (
    <filesInfo.Provider value={{ databaseFile, setDatabaseFile, dataFile, setDataFile, dataFileColumn, setDataFileColumn, dataBaseFileColumn, setDataBaseFileColumn, description, setDescription }}>
      {children}
    </filesInfo.Provider>
  );
}